    ...
    return Scaffold(
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Container(
                                        width: 60,
                                        child: Text("${items[index]["price"]/items[index]["discountPercentage"]}",
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text(items[index]["discountPercentage"].toString(),style: TextStyle(
                                       ...
                                       Container(
                                        width: 72,
                                        child: items[index]["rating"]>3? Row(children: [
      ...
      SizedBox(height: 5,),
                                Container(
                                  ...
                                  width: double.infinity,
                                   padding: EdgeInsets.only(left: 15,right: 10),
                                  child: Text("Stock Left:  ${items[index]["stock"]}",style: TextStyle(
                                    fontSize: 11
                                  ),),
                                ),
      SizedBox(height: 8,),                             
                                Container(
                                  ...
                                  child: Text("  ${items[index]["shippingInformation"]}",
                                  overflow: TextOverflow.ellipsis,
                                  maxLines: 2,
